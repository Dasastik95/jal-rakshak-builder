...
function LoginPage() {
  ...
  // If session exists but MFA is required, redirect to verify page
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Check admin role using the live DB (auth.refresh updates state but state may be stale here)
